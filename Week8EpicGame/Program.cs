...
//string[] heroes = { "Police", "Ambulance", "Firefigters", "Army", "Navy" };
//string[] villains = { "Pätid", "Püromaanid", "Vigastajad", "Piraadid", "Pahad" };
...
string[] weapon = { "tuli", "pikad näpud", "relv", "mõõk", "nuiad" };
